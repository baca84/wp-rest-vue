...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    }, [_vm._v("\n\t\t\t\t\t\t\t" + _vm._s(page.title) + "\n\t\t\t\t\t\t")])] : [_c('p', [_vm._v(_vm._s(page.title))])], _vm._v(" "), (page.children) ? _c('ul', {
	      staticClass: "m-menu"
